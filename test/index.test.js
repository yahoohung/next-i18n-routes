...
describe('Routes', () => {
  ...
  test('add with object', () => {
    setup({ name: 'a' }).testRoute({ name: 'a', pattern: '/:lang(zh-cn|en)?/a', page: '/a' })
  })

  test('add with name', () => {
    setup('a').testRoute({ name: 'a', pattern: '/:lang(zh-cn|en)?/a', page: '/a' })
  })

  test('add with name and pattern', () => {
    setup('a', '/:a').testRoute({ name: 'a', pattern: '/:lang(zh-cn|en)?/:a', page: '/a' })
  })

  test('add with name, pattern and page', () => {
    setup('a', '/:a', 'b').testRoute({ name: 'a', pattern: '/:lang(zh-cn|en)?/:a', page: '/b' })
  })

  test('add with pattern and page', () => {
    setup('/:a', 'b').testRoute({ name: null, pattern: '/:lang(zh-cn|en)?/:a', page: '/b' })
  })
  ...
  test('match and merge params into query', () => {
    const routes = nextRoutes({
      ...
      locales: ['zh-cn', 'en'],
      defaultLocale: 'zh-hk'
    }).add('a').add('b', '/:a?/b/:b').add('c')
    const { query } = routes.match('/b/b?b=b&c=c')
